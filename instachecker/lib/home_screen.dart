...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // initialization of scrapper code
  ...
  void initState() {
    super.initState();
    // initial text (app opened from a share)
  ...
  void _handleAnalyze(String input) async {
    ...
    await _searchService.startAutomatedScan("Is Instagram user @$targetUser posting reliable information?");
    
    // final report generated by the background logic
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ResultScreen(
          ...
          // Mapping the verdict to a physical score
          score: report['position'] == "Supported" ? 0.92 : 0.25,
          status: report['position'], 
          reason: report['summary'],
          transcript: "Analysis finished. Scanned ${report['ordered_sources'].length} sources found on the web regarding this user.",
          
          // mapping the actual URLs the scraper discovered
          sources: _searchService.verifiedResults.map((r) => r['url']!).toList(),
        ),
      ),
    );
  }
